...
-- Source recovered byte-for-byte from the canonical recovery shard.
-- Equivalence to the live historical statement is unprovable because the provider retained only a prose marker.
