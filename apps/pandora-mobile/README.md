...
The repository CI uses pinned Flutter 3.47.0, creates disposable Android/Web platform scaffolding around the complete app package, verifies deterministic brand assets, formats, analyzes, tests, compares reviewed goldens, and creates release-mode Web plus debug Android artifacts.
