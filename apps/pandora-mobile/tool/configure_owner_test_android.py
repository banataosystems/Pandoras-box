...
_OWNER_TEST_LABEL = 'android:label="Pandora"'
...
def configure_manifest(manifest: Path) -> int:
    ...
    updated = text.replace(_GENERATED_LABEL, _OWNER_TEST_LABEL, 1)
    ...
    if verified.count(_OWNER_TEST_LABEL) != 1 or _GENERATED_LABEL in verified:
