#!/usr/bin/env python3
"""Regression tests for the bounded Owner Test Android manifest patch."""
...
_SCRIPT = Path(__file__).with_name("configure_owner_test_android.py")
...
class ConfigureOwnerTestAndroidTest(unittest.TestCase):
    ...
    def test_adds_release_internet_permission_and_owner_label(self) -> None:
