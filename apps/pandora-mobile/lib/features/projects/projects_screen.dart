  ...
  Widget build(BuildContext context) => PandoraPage(
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, _) {
            ...
            final ownerProjects =
                allProjects.where(isOwnerVisibleProject).toList(growable: false);
            final projects = _visible(allProjects);
            final blocked = ownerProjects
                .where((project) =>
                    resolveOwnerProjectState(project) == OwnerProjectState.blocked)
                .length;
            final working = ownerProjects
                .where((project) =>
                    resolveOwnerProjectState(project) == OwnerProjectState.executing)
                .length;
          ...
          child: Column(
            ...
            children: [
              ...
              if (project.phase != 'Phase not verified') ...[
                const SizedBox(height: PandoraSpacing.sm),
                Text(project.phase, style: Theme.of(context).textTheme.bodySmall),
              ],
