...
class ConnectionSummary {
  ...
  factory ConnectionSummary.fromJson(Object? value) {
    ...
    return ConnectionSummary(
      ...
      purpose: jsonText(json['plainPurpose'], fallback: 'Service purpose not recorded.'),
      ...
      freshness: FreshnessInfo.fromJson(<String, Object?>{...json, 'lastVerifiedAt': json['lastCheckedAt']}),
      provider: jsonText(json['provider'], fallback: jsonText(advanced['provider'], fallback: 'unknown')),
      authMode: jsonText(json['authMode'], fallback: jsonText(advanced['authMode'], fallback: 'unknown')),
